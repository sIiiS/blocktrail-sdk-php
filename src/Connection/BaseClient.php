 ...
 *
 */
abstract class BaseClient implements RestClientInterface
{
     ...
     * @return Response
     */
    abstract public function request($method, $endpointUrl, $queryString = null, $body = null, $auth = null, $contentMD5Mode = null, $timeout = null);
